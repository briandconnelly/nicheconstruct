...
We see in [Figure 2A](#fig2) that despite oscillations, cooperation is maintained at high levels in most of these populations.
...
In such a case, any sequence of integers on the circular genome will always contain a break in the sequence; that is, one locus will have an allele that is not one less than the allele at the next locus.
