...
A different case emerges when a mismatch exists.
...
This genotype has a mismatch, because the niche constructed by allele 5 favors allele 6 (not 1) at the next locus (locus 1).
